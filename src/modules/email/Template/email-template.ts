...
export const FAISAL_RIDE_COLORS = {
  primary: '#2C3E4C',
  accent: '#00796B',
  background: '#E6E9EE',
  textDark: '#0F2538',
  ...
  <td align="center">
    ...
    >
      <tr>
        <td>
          <div style="
            border: 3px solid ${FAISAL_RIDE_COLORS.accent};
            border-radius: 4px;
            margin: 32px auto;
          "></div>
        </td>
...
export const emailButton = (
  ...
  // Faisal Ride brand colors
  const primaryColor = FAISAL_RIDE_COLORS.primary; // Navy #2C3E4C
  const accentColor = FAISAL_RIDE_COLORS.accent;   // Teal #00796B
  ...
  const link2Element = link2
    ? `
          ...
          <button 
          style="
            background-color: ${link2.variant === 'success' ? accentColor : primaryColor};
            border: 2px solid ${link2.variant === 'success' ? accentColor : primaryColor};
            border-radius: 8px;
            height: 44px;
            font-size: 14px;
            color: white;
